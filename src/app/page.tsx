      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {['smartphones', 'laptops', 'books', 'skincare', 'fragrances', 'home-decoration', 'furniture', 'tops', 'womens-dresses', 'mens-shirts', 'mens-watches', 'womens-bags', 'sunglasses', 'automotive'].map(category => (
